...
Add Agora RTC media to a WebXR scene for immersive browser-based communication.

Use this recipe when you want a working reference for WebXR, RTC media, immersive scene, browser.

Repository: [AgoraIO-Community/AgoraWebXR](https://github.com/AgoraIO-Community/AgoraWebXR)
...
```text
You are working in `AgoraIO-Community/AgoraWebXR`. Add or adapt this sample so a developer can run the webxr rtc demo end to end with Agora RTC.
